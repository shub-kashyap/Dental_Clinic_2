  ...
  return (
    <div className={styles.floatingBar}>
      ...
      <a
        ...
        title="24/7 Emergency Dental Line"
      >
        <span className={styles.pulseDot} />
        <span className={styles.phoneIcon}>⚡</span>
        <span className={styles.btnLabel}>24/7 Emergency Care</span>
      </a>
